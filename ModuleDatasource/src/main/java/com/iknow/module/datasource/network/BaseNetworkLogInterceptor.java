...
public abstract class BaseNetworkLogInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        String developLog = chain.request().header("developLog");
        if (!TextUtils.isEmpty(developLog)) {
    ...
    protected abstract void doSend(@NonNull NetWorkLogInfoBean netWorkLogInfo);
